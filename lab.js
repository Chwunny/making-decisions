...
console.log(arr)
console.log(lastItemRemoved) //To double check code is working as intended.
...
////////// PROBLEM 13 //////////
// Switch statements can be excellent alternatives to for loops. Look up switch statements (I recommend W3 Schools) 
